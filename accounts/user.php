						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h4><button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addnew"> Add User </button></h4>
								</div>
								<div class="card-body">
													...
													<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
														<div class="modal-content">
															<div class="modal-header bg-warning">
																<h5 class="modal-title white" id="myModalLabel130">Delete Officer</h5>
															...
															<div class="modal-body">
																<form action="#" enctype="multipart/form-data" method="POST">
																	<div class="modal-body">
																		...
																		ARE YOU SURE TO DELETE THIS OFFICER ?
																	</div>
													...
													<div class="modal-body">
														...
														<div class="form-group">
															<select name="role" id="sponsor" class="form-control" required>
																<?php if ($val->position == 1) { ?>
																	<option value="1" selected> Program Proponent </option>
																	<option value="2"> Program Implementer</option>
																<?php  } else if ($val->position == 2) { ?>
																	<option value="1"> Program Proponent </option>
																	<option value="2" selected> Program Implementer</option>
																<?php } ?>
